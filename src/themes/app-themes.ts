...
const ARCTIC: AppTheme = {
  ...
  tokens: {
    ...
    "--theme-border": "#8a9aab",
    /* Ink-dark frames on light face — must read at a glance */
    "--theme-frame-border": "rgba(35, 55, 85, 0.34)",
    "--theme-frame-border-strong": "rgba(30, 50, 80, 0.5)",
    "--theme-border-subtle": "var(--theme-frame-border)",
    "--theme-accent": "#4a7e9e",
    "--theme-accent-bright": "#5b9ec4",
    "--theme-accent-dim": "#5a7088",
    "--theme-accent-glow": "rgba(91, 158, 196, 0.28)",
    "--theme-accent-soft": "rgba(91, 158, 196, 0.1)",
    "--theme-chip-bg": "rgba(91, 158, 196, 0.1)",
    "--theme-chip-border": "rgba(50, 90, 130, 0.42)",
    "--theme-chip-text": "#3a5470",
    "--theme-chip-hover-border": "rgba(45, 95, 140, 0.58)",
    "--theme-chip-hover-text": "#1a4060",
    "--theme-chip-active-bg": "rgba(91, 158, 196, 0.28)",
    "--theme-chip-active-border": "rgba(40, 90, 130, 0.75)",
    "--theme-chip-active-text": "#0e2f4a",
    ...
    /* Diamond/GRIT bottom vignette — keep light (black 28% looks like cast shadow on short frames) */
    "--theme-bezel-bottom-shade": "color-mix(in srgb, #4a5a6a 9%, transparent)",
    "--theme-bezel-dot-shade": "color-mix(in srgb, #4a5a6a 6%, transparent)",
