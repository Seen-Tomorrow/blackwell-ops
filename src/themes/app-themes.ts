...
const AMBER: AppTheme = {
  ...
  tokens: {
    ...
    "--theme-cockpit-header-shadow": "inset 0 1px 0 color-mix(in srgb, #ffffff 6%, transparent), inset 0 -1px 0 color-mix(in srgb, #000000 28%, transparent)",
    "--display-face-light-surface": "#c9c9c9",
    "--display-face-light-bar-bg": "#645030",
    "--display-face-light-dot": "rgba(0, 0, 0, 0.028)",
    "--display-face-light-band": "rgba(0, 0, 0, 0.014)",
    "--display-face-light-band-opacity": "0.45",
    "--display-face-light-text-muted": "#6a5028",
    "--display-face-light-readout": "#4a3018",
    "--display-face-light-readout-divider": "#4a3018",
    "--display-face-light-readout-divider-opacity": "0.3",
    "--display-face-light-readout-idle": "#8a7050",
...
const CYAN: AppTheme = {
  ...
  tokens: {
    ...
    "--theme-cockpit-header-shadow": "inset 0 1px 0 color-mix(in srgb, #ffffff 6%, transparent), inset 0 -1px 0 color-mix(in srgb, #000000 28%, transparent)",
    "--display-face-light-surface": "#c9c9c9",
    "--display-face-light-bar-bg": "#3a5a5a",
    "--display-face-light-dot": "rgba(0, 0, 0, 0.028)",
    "--display-face-light-band": "rgba(0, 0, 0, 0.014)",
    "--display-face-light-band-opacity": "0.45",
    "--display-face-light-text-muted": "#2a5a6a",
    "--display-face-light-readout": "#0a4a58",
    "--display-face-light-readout-divider": "#0a4a58",
    "--display-face-light-readout-divider-opacity": "0.3",
    "--display-face-light-readout-idle": "#4a7888",
...
const SLATE: AppTheme = {
  ...
  tokens: {
    ...
    "--theme-cockpit-header-shadow": "inset 0 1px 0 color-mix(in srgb, #ffffff 6%, transparent), inset 0 -1px 0 color-mix(in srgb, #000000 28%, transparent)",
    "--display-face-light-surface": "#c9c9c9",
    "--display-face-light-bar-bg": "#5a5a60",
    "--display-face-light-dot": "rgba(0, 0, 0, 0.028)",
    "--display-face-light-band": "rgba(0, 0, 0, 0.014)",
    "--display-face-light-band-opacity": "0.45",
    "--display-face-light-text-muted": "#5a5a6a",
    "--display-face-light-readout": "#2e2e38",
    "--display-face-light-readout-divider": "#2e2e38",
    "--display-face-light-readout-divider-opacity": "0.28",
    "--display-face-light-readout-idle": "#6a6a78",
...
const ARCTIC: AppTheme = {
  ...
  tokens: {
    ...
    "--display-face-light-band-opacity": "0.32",
