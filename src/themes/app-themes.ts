...
const SLATE: AppTheme = {
  ...
  tokens: {
    ...
    "--theme-chip-bg": "rgba(200, 200, 210, 0.025)",
    ...
    "--theme-chip-active-bg": "rgba(200, 200, 210, 0.065)",
...
const ARCTIC: AppTheme = {
  ...
  tokens: {
    ...
    /* Readable ink on dark CRT — not full-face grey fog */
    /* Subtle slate-like grain (was 14% grey → unreadable veil) */
    "--theme-phosphor-text": "#243044",
    "--theme-phosphor-text-muted": "#5a6a7c",
    "--theme-phosphor-bar-bg": "rgba(36, 48, 68, 0.07)",
    ...
    "--theme-phosphor-border": "rgba(100, 120, 140, 0.18)",
    ...
    /* Icy translucent blue — not clay white wash */
    "--theme-industrial-gpu-card-bg": "rgba(91, 158, 196, 0.14)",
    "--theme-industrial-gpu-border": "rgba(91, 158, 196, 0.32)",
    "--theme-industrial-gpu-selected": "rgba(91, 158, 196, 0.65)",
    ...
    "--theme-phosphor-inset-top": "rgba(60, 80, 100, 0.05)",
    "--theme-phosphor-inset-bottom": "rgba(60, 80, 100, 0.025)",
    ...
    "--theme-launch-bg": "color-mix(in srgb, var(--theme-chip-solid-bg) 55%, var(--theme-industrial-bg) 45%)",
    ...
    "--theme-cockpit-well-shadow": "inset 0 2px 5px color-mix(in srgb, #2a3848 10%, transparent), inset 0 1px 0 color-mix(in srgb, #2a3848 6%, transparent), inset 0 -1px 0 color-mix(in srgb, #ffffff 50%, transparent), 0 1px 0 color-mix(in srgb, #ffffff 35%, transparent)",
