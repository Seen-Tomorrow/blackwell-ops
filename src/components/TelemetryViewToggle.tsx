...
export default function TelemetryViewToggle({ mode, onChange }: TelemetryViewToggleProps) {
  return (
    <div className="flex-shrink-0 flex items-center justify-between gap-3 theme-surface rounded-sm px-3 py-2">
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        <button
          ...
          className={`px-2.5 py-1 text-[8px] font-mono tracking-wider rounded-sm border transition-colors focus:outline-none ${
            mode === "standard"
