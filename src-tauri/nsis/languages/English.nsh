...
LangString dontUninstall ${LANG_ENGLISH} "Update in place (keeps foundry builds, config, and engines)"
...
LangString uninstallApp ${LANG_ENGLISH} "Uninstall ${PRODUCTNAME} (removes app and bundled runtime — foundry/config folders may remain)"
